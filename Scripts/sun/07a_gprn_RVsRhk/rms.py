...
a, b, c = GPRN.Prediction(nodes, weight, means, jitter, tstar, m, v,  variance=True)
...
irms1 = utils.wrms(val1, val1err)
rms1 = utils.wrms(residuals1, val1err)
residuals2 = val2 - np.array(val2Pred)
irms2 = utils.wrms(val2, val2err)
rms2 = utils.wrms(residuals2, val2err)

print('INITIAL:', irms1, irms2)
print('FINAL:', rms1, rms2)
print('I/F:', irms1/rms1, irms2/rms2)