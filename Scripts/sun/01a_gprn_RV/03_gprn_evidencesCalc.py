...
###### Data .rdb file #####
time,rv,rverr,bis,biserr,fwhm,fwhmerr= np.loadtxt("sunBinned_Dumusque.txt",
                                                  skiprows = 1, unpack = True,
                                                  usecols = (0,1,2,7,8,9,10))

###### GP object #####
time, val1, val1err, val2,val2err = time, rv, rverr,bis,biserr
...
prior = priors(filename="sunBinned_Dumusque.txt", 
               RVs=True, BIS=False, FWHM=False, RHK=False)
