...
axs['node'].plot(t, n, 'o', color='black', alpha=0.5)
...
axs['predictive3'].errorbar(time, val3, val3err, fmt= 'ob', alpha=0.5)
axs['predictive3'].xaxis.set_minor_locator(AutoMinorLocator(5))
axs['predictive3'].yaxis.set_minor_locator(AutoMinorLocator(5))
axs['predictive3'].grid(which='major', alpha=0.5)
axs['predictive3'].grid(which='minor', alpha=0.2)
...
axs['residuals1'].tick_params(axis='both', which='both', labelbottom=False)
...
axs['residuals3'].tick_params(axis='both', which='both', labelbottom=True)
...
axs['predictive3'].plot(tstar, a[:,1].T, '-k')
...
axs['node'].plot(tstar, -dd[0].T, '-k')
bmin = -dd[0] - np.sqrt(nVar)
bmax = -dd[0] + np.sqrt(nVar)
