...
plt.rcParams['figure.figsize'] = [10/1.5, 10/1.5]
...
axs.text(0.98, 0.05, textstr, transform=axs.transAxes, fontsize=10,
         ha='right', bbox=props)
...
axs.scatter(result1.orbital_period, result1.mass, s=10, facecolors='none',
            marker='^', color='blue', alpha=0.9, label='Primary transit')
axs.scatter(result2.orbital_period, result2.mass, s=10, facecolors='none',
            marker='v', color='red', alpha=0.9)
axs.scatter(result2.orbital_period, result2.mass_sini, s=10, facecolors='none',
            marker='v', color='red', alpha=0.9, label='Radial velocity')
axs.scatter(result3.orbital_period, result3.mass, s=10, facecolors='none',
            marker='*', color='green',alpha=0.9, label='Imaging')
axs.scatter(result4.orbital_period, result4.mass, s=10, facecolors='none',
            marker='o', color='orange',alpha=0.9, label='Microlensing')
axs.scatter(result5.orbital_period, result5.mass, s=10, facecolors='none',
            marker='P', color='purple',alpha=0.9, label='Astrometry')
plt.legend(facecolor='white', framealpha=1, edgecolor='black',
            loc=1, bbox_to_anchor=(1, 0.30))
