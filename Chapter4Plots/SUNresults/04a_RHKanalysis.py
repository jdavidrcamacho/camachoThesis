...
gpResults = "/home/camacho/GPRN/01_SUN/70_sun/GP/04a_GP_Rhk/savedProgress.h5"
gprnResults = "/home/camacho/GPRN/01_SUN/70_sun/GPRN/04a_gprn_Rhk/savedProgress.h5"
...
#plt.tight_layout()
#plt.savefig('logRhkfit_ResidualDifferencePlot.pdf', bbox_inches='tight')
#plt.close('all')
...
#plt.ylabel('%')
#plt.savefig('logRhkfit_percentagePlot.pdf', bbox_inches='tight')
#plt.close('all')
