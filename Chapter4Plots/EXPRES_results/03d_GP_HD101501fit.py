...
filename = "/media/camacho/HDD 1 tb/GPRN/02_EXPRES/New/HD101501/02c_GP_RVsFWHM/savedProgress.h5"
...
plt.savefig('GP_HD101501fitS.pdf', bbox_inches='tight')
# plt.close('all')
