...
gpResults = "/media/camacho/HDD 1 tb/GPRN/01_SUN/70_sun/GP/06b_GP_RVsFWHM/savedProgress.h5"
...
plt.savefig('RVFWHMfit_withResidualsPlot.pdf', bbox_inches='tight')
plt.close('all')
...
plt.tight_layout(pad=0.1, h_pad=0.25, w_pad=0.1)
plt.savefig('RVFWHMfit_withResidualsPlotb.pdf', bbox_inches='tight')
plt.close('all')